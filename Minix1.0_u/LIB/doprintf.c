...
PRIVATE void _bintoascii (long num, int radix, char *a)
//long    num;
//int     radix;
//char    *a;
{
...
PRIVATE void _printit(char *str, int w1,int w2, char padchar, int length, FILE *file)
//char *str;
//int w1, w2;
//char padchar;
//int length;
...
void _doprintf(FILE *fp, char *format, int args)
{
	char *vl;
	int  r,w1, w2,sign;
	long l;
