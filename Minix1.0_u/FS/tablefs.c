...
extern do_open_fs(), do_close_fs(), do_creat(), do_link(), do_unlink();
extern no_sys(), do_fork_fs(), do_exit_fs(), do_read_fs(), do_write_fs();
extern do_chdir(), do_time(), do_mknod(), do_chmod(), do_chown(),do_stat();
extern do_lseek(), do_mount(), do_umount(), do_set(), do_stime(),do_fstat();
extern do_utime(), do_access(), do_sync(),do_dup(),do_pipe(),do_tims();
extern do_ioctl(), do_umask(), do_chroot(),do_unpause(),do_revive();
