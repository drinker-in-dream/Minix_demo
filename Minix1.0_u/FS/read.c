 ...
 *				rw_user					     *
 *===========================================================================*/
PUBLIC int rw_user(int s, int u, vir_bytes vir, vir_bytes bytes, char *buff, int direction)
 ...
 *				rw_chunk				     *
 *===========================================================================*/
PRIVATE int rw_chunk(struct inode *rip, file_pos position, unsigned off, int chunk, int rw_flag, char *buff, int seg, int usr)
//struct inode *rip;	/* pointer to inode for file to be rd/wr */
 ...
 *				read_map				     *
 *===========================================================================*/
PUBLIC block_nr read_map(struct inode *rip, file_pos position)
//struct inode *rip;	/* ptr to inode to map from */
