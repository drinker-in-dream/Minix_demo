 ...
 *				size_ok  				     *
 *===========================================================================*/
PUBLIC int size_ok(int file_type, vir_clicks tc, vir_clicks dc, vir_clicks sc, vir_clicks dvir, vir_clicks s_vir)
 ...
 *				stack_fault  				     *
 *===========================================================================*/
PUBLIC void stack_fault(int proc_nr)
 ...
 *				adjust  				     *
 *===========================================================================*/
PUBLIC int adjust(struct mproc *rmp, vir_clicks data_clicks, vir_bytes sp)
//struct mproc *rmp;	/* whose memory is being adjusted? */
 ...
 */
  ...
  //sys_getsp(mm_who, &new_sp);	/* ask kernel for current sp value */
