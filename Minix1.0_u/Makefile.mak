...
INITOBJS =  ./INIT/BUILD/init.o ./INIT/BUILD/initc.o  ./INIT/BUILD/utility_init.o 
...
./BUILD/crtso.o : ./LIB/crtso.asm
	$(ASM) $(ASMKFLAGS) -o $@ $< 
 
./INIT/BUILD/initc.o: INIT/init.c H/signal.h H/const.h H/type.h H/com.h
	$(CC) $(CFLAGS) -o $@ $< 

./INIT/BUILD/utility_init.o: INIT/utility_init.c H/const.h H/type.h H/com.h
	$(CC) $(CFLAGS) -o $@ $< 
