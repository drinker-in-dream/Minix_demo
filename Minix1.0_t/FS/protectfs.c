 ...
 *				forbidden				     *
 *===========================================================================*/
PUBLIC int forbidden(struct inode *rip, mask_bits access_desired, int real_uid)
//struct inode *rip;	/* pointer to inode to be checked */
 ...
 */
  ...
  mask_bits bits, perm_bits, xmask;
