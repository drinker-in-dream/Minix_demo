...
/* Search the superblock table for this device.  It is supposed to be there. */
    ...
    printk("can't find superblock for device (in decimal) %d \n", (int) dev);
}
 ...
 *				unload_bit_maps				     *
 *===========================================================================*/
PUBLIC unload_bit_maps(dev_nr dev)
