 ...
 *				pipe_check				     *
 *===========================================================================*/
PUBLIC int pipe_check(struct inode *rip, int rw_flag, int virgin, int bytes,file_pos *position)
//struct inode *rip;	/* the inode of the pipe */
//int rw_flag;			/* READING or WRITING */
//int virgin;			/* 1 if no data transferred yet, else 0 */
//int bytes;		/* bytes to be read or written (all chunks) */
//file_pos *position;	/* pointer to current file position */
{
 ...
 *				revive					     *
 *===========================================================================*/
PUBLIC revive(int proc_nr, int bytes)
 ...
 *				release					     *
 *===========================================================================*/
PUBLIC release(struct inode *ip, int call_nr, int count)
//struct inode *ip;	/* inode of pipe */
