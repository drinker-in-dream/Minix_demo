 ...
 *				panic					     *
 *===========================================================================*/
PUBLIC void panic_mm(char *format, int num)
 ...
 *				mem_copy				     *
 *===========================================================================*/
PUBLIC int mem_copy(int src_proc,int src_seg, long src_vir, int dst_proc,int dst_seg, long dst_vir, long bytes)
