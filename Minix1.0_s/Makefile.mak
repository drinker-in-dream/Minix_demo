...
OBJS		=  ./BUILD/KERNEL.o ./BUILD/main.o ./BUILD/klibx86.o ./BUILD/table.o \
  ...
  ./BUILD/misc.o ./BUILD/mount.o ./BUILD/open_fs.o ./BUILD/stadir.o ./BUILD/syslib.o \
  ./BUILD/call.o ./BUILD/message.o ./BUILD/mm_main.o ./BUILD/table_mm.o ./BUILD/put_mm.o \
  ./BUILD/utility_mm.o ./BUILD/open.o ./BUILD/close.o ./BUILD/fstat.o ./BUILD/getset.o \
  ./BUILD/alloc.o ./BUILD/break.o ./BUILD/exec.o ./BUILD/forkexit.o ./BUILD/signal_mm.o \
  ./BUILD/exit.o ./BUILD/abort.o ./BUILD/access.o ./BUILD/alarm.o ./BUILD/brk.o ./BUILD/brk2.o \
  ./BUILD/chdir.o ./BUILD/chmod.o ./BUILD/chown.o ./BUILD/chroot.o ./BUILD/cleanup.o ./BUILD/creat.o \
  ./BUILD/crypt.o ./BUILD/dup.o ./BUILD/dup2.o ./BUILD/execlib.o ./BUILD/fclose.o ./BUILD/fflush.o \
  ./BUILD/writelib.o ./BUILD/printdat.o ./BUILD/putc.o ./BUILD/doprintf.o ./BUILD/getc.o ./BUILD/readlib.o \
  ./BUILD/fgets.o ./BUILD/fopen.o ./BUILD/lseek.o ./BUILD/malloc.o ./BUILD/fseek.o ./BUILD/fork.o \
  ./BUILD/fprintf.o ./BUILD/fputs.o ./BUILD/fread.o ./BUILD/freopen.o ./BUILD/fwrite.o ./BUILD/getegid.o \
  ./BUILD/getenv.o ./BUILD/geteuid.o ./BUILD/getgid.o ./BUILD/getgrent.o ./BUILD/getpass.o ./BUILD/getpid.o \
  ./BUILD/getpwent.o ./BUILD/gets.o ./BUILD/getuid.o ./BUILD/index.o ./BUILD/ioctl.o ./BUILD/isatty.o \
  ./BUILD/kill.o ./BUILD/linklib.o ./BUILD/mknod.o ./BUILD/mountlib.o ./BUILD/pause.o ./BUILD/perror.o \
  ./BUILD/pipelib.o ./BUILD/prints.o ./BUILD/rand.o ./BUILD/rindex.o ./BUILD/setbuf.o ./BUILD/setgid.o \
  ./BUILD/setuid.o ./BUILD/sleep.o ./BUILD/signal.o ./BUILD/sprintf.o ./BUILD/stat.o ./BUILD/stb.o \
  ./BUILD/stderr.o ./BUILD/stime.o ./BUILD/sync.o ./BUILD/timelib.o ./BUILD/times.o ./BUILD/umask.o \
  ./BUILD/umount.o ./BUILD/ungetc.o ./BUILD/unlink.o ./BUILD/utime.o ./BUILD/wait.o 
