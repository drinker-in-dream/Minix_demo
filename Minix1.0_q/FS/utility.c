...
/* This routine returns the time in seconds since 1.1.1970. */
	...
	if ( (k = sendrec(CLOCK, &clock_mess)) != OK) printk("clock_time err\n");
 ...
 *				cmp_string				     *
 *===========================================================================*/
PUBLIC int cmp_string(char *rsp1, char *rsp2, int n)
//char *rsp1, *rsp2;	/* pointers to the two strings */
//int n;			/* string length */
{
 ...
 *				copy					     *
 *===========================================================================*/
PUBLIC void fscopy(char *dest, char *source, int bytes)
 ...
 */
  ...
  printk("File system panic: %s ", format);
