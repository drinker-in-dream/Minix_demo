...
cp_mess:
	...
	mov edi,[ebp + 20]		; di = offset of destination buffer
	mov es,[ebp + 18]		; es = clicks of destination
	mov esi,[ebp + 14]		; si = offset of source	message
	mov ds,[ebp + 12]		; ds = clicks of source	message
	mov [es:edi],eax		; copy sender's	process	number to dest message
